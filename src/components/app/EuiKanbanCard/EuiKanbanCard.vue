...
<template>
  <article
    class="bg-card border border-border rounded-md p-2 cursor-grab text-[12.5px] hover:border-foreground/30 transition-colors"
    draggable="true"
    :data-name="card.name"
    @dragstart="onDragStart"
  >
    <div class="font-mono text-muted-foreground text-[11px] flex items-center gap-2">
